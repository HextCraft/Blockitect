...
public class ShadowRenderer {
    ...
    private void setupDepthShader() throws Exception {
        ...
        depthShaderProgram.createVertexShader(Utils.loadResource("/assets/blockitect/shaders/depth_vertex.vs"));
        depthShaderProgram.createFragmentShader(Utils.loadResource("/assets/blockitect/shaders/depth_fragment.fs"));
