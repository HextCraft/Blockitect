...
public class ShadowTestRenderer {
    ...
    private void setupTestShader() throws Exception {
        ...
        testShaderProgram.createVertexShader(Utils.loadResource("/assets/blockitect/shaders/test_vertex.vs"));
        testShaderProgram.createFragmentShader(Utils.loadResource("/assets/blockitect/shaders/test_fragment.fs"));
        ...
        quadMesh = OBJLoader.loadMesh("/assets/blockitect/models/quad.obj");
    }
