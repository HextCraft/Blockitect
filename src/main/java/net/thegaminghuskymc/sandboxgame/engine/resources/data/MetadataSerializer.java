...
import net.thegaminghuskymc.sandboxgame.engine.util.registry.IRegistry;
import net.thegaminghuskymc.sandboxgame.engine.util.registry.RegistrySimple;
import net.thegaminghuskymc.sandboxgame.engine.util.text.ITextComponent;
import net.thegaminghuskymc.sandboxgame.engine.util.text.Style;
