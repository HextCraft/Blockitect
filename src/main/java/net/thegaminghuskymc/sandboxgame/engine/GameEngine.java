...
public class GameEngine implements Runnable {
    ...
    private GameEngine(String windowTitle, int width, int height, boolean vSync, Window.WindowOptions opts, IGameLogic gameLogic) throws Exception {
    ...
    public void start() {
        ...
        PathUtils.loadGamedir();

        /*for(EnumGui gui : EnumGui.values()) {
            GuiJsonWriter.writeGUIJson(gui.getName(), gui.getComponents());
        }*/
